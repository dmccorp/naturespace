...
import { OrbitControls } from "./3DLib/OrbitControls";
import TWEEN from "./3DLib/Tween";

const nbButterflies = 12;
var conf, scene, camera, cameraCtrl, light, renderer;
var whw, whh;

var butterflies;
var bodyTexture, wingTexture1, wingTexture2, wingTexture3;
...
export default ()=> {
    ...
    return (
        <div class={styles.butterflyContainer} id="bg"></div>
    )
}